      ...
      <main>
        ...
        <section className="container mx-auto px-4 py-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 bg-card rounded-2xl shadow-card border border-border">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-2">Multi-Tenant Security</h4>
            ...
            <div className="p-6 bg-card rounded-2xl shadow-card border border-border">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-2">Academic Management</h4>
              <p className="text-muted-foreground">
            ...
            <div className="p-6 bg-card rounded-2xl shadow-card border border-border">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-2">AI-Powered Tools</h4>
              <p className="text-muted-foreground">
            ...
            <div className="p-6 bg-card rounded-2xl shadow-card border border-border">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-2">Complete Platform</h4>
              <p className="text-muted-foreground">
        ...
        <section className="container mx-auto px-4 py-20">
          <div className="bg-gradient-primary rounded-3xl p-12 text-center text-white">
            <h3 className="text-4xl font-bold mb-4">Ready to Transform Your School?</h3>
